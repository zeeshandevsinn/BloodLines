      ...
      children.forEach((child) {
        ...
        switch (configuration.orientation) {
          ...
          case BuchheimWalkerConfiguration.ORIENTATION_LEFT_RIGHT:
            linePath.moveTo(child.x-5, child.y + child.height / 2);
            linePath.lineTo(child.y +40, child.y + child.height / 2);
            linePath.lineTo(child.y +40, node.y + node.height / 2);

            // linePath.moveTo(0, node.y + node.height / 2);
            // linePath.lineTo(0, node.y + node.height / 2);
