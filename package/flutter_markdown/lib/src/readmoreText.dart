...
class ReadMoreTextState extends State<ReadMoreText> {
  ...
  TextSpan _buildData({
    ...
    final Iterable<Match> matches = REGEX_EMOJI.allMatches(data);
    ...
    if(matches.isEmpty){
      ...
      for (var t in data.characters)
       span.add( TextSpan(
            text: t,
            style: textStyle!.copyWith(
              fontSize: REGEX_EMOJI.allMatches(t).isNotEmpty ? 20.0 :textStyle.fontSize,
            )));
      return TextSpan(
        children: span..addAll(children),
        style: textStyle,
      );;
    }
  }
